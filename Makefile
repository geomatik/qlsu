...
deploy: compile doc transcompile
	...
	(foreach EXTRA_DIR,(EXTRA_DIRS), cp -R (EXTRA_DIR) (QGISDIR)(PLUGINNAME)/;)
...
zip: deploy dclean
	...
	rm -f $(PLUGINNAME).zip
	cd $(QGISDIR)s; zip -9r $(CURDIR)/$(PLUGINNAME).zip $(PLUGINNAME)
